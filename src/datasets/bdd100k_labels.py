'''
This code is based on https://github.com/mcordts/cityscapesScripts/blob/master/cityscapesscripts/helpers/labels.py
Date : 20.10.2019
----------------------
...
For details on the license please have a look at MasterThesis/Licenses/Cityscapes_scripts_License.txt
'''
...
#########################################19 class pixels +1 unlabelled(ignore)